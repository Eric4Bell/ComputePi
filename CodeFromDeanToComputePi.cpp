...
////    std::cout << std::endl;
////
////    //std::stringstream piHex;
////    //piHex << std::hex << piDigitHex(1);
////    //std::cout << piHex.str() << std::endl;
////
////    //std::cout << std::hex << piDigitHex(1) << std::endl;
////    //std::cout << std::hex << piDigitHex(2) << std::endl;
////    //std::cout << std::hex << piDigitHex(3) << std::endl;
